...
TEST_CASE( "multivector construction", "[multivector]" )
{
    ...
    SECTION( "fill constructor" )
    {
        ...
        multivector<types<char, uint16_t, std::string, std::unique_ptr<int>>> v(size);
    ...
    SECTION( "move constructor" )
    {
        ...
        multivector<types<char, uint16_t, std::string, std::unique_ptr<int>>> v_prim(std::move(v));
...
TEST_CASE( "multivector assignment", "[multivector]" )
{
    ...
    SECTION( "move assignment" )
    {
        ...
        multivector<types<char, uint16_t, std::string, std::unique_ptr<int>>> v_prim;
        v_prim = std::move(v);
...
TEST_CASE( "multivector resizing", "[multivector]" )
{
    ...
    SECTION( "reserve" )
    {
        ...
        multivector<types<char, uint16_t, std::vector<int>, std::unique_ptr<int>>> v(size);
...
TEST_CASE( "multivector iteration", "[multivector]" )
{
    ...
    SECTION( "reverse_iterator" )
    {
        ...
        for(multivector_type::reverse_iterator it = v.rbegin(); it != v.rend(); ++it) {
            switch(it - v.rbegin()) {
                case 3:
                    REQUIRE(v.get<0>(it) == 'x');
                    REQUIRE(v.get<1>(it) == 100);
